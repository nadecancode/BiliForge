...
public class UIEColorWheel extends UIEClickZone {
    ...
    public class ColorPickerGUI extends GuiScreen {
        ...
        @Override
        public void initGui() {
            buttonList.add(applyButton = new GuiButton(0, width / 2 - 65, height / 2 + 95, 50, 20, ChatColor.GREEN + "确认"));
            buttonList.add(cancelButton = new GuiButton(1, (width / 2) + 15, height / 2 + 95, 50, 20, ChatColor.RED + "取消"));
        ...
        public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            drawCenteredString(mc.fontRendererObj, "调色盘", (width / 2), (height / 2) - 110, 0xFFFFFF);
            drawCenteredString(mc.fontRendererObj, "点击来选择一个颜色!", (width / 2), (height / 2) - 100, 0xFFFFFF);
