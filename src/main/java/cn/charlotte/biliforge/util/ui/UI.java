...
import cn.charlotte.biliforge.util.ui.elements.UIEColorWheel;
import cn.charlotte.biliforge.util.ui.elements.UIEList;
import cn.charlotte.biliforge.util.ui.elements.UIETextBox;
...
public abstract class UI extends GuiScreen {
    ...
    public static void setupUI(UI ui) {
        for (Field f : ui.getClass().getFields()) {
            try {
                if (f.get(ui) instanceof UIElement) {
    ...
    public static abstract class CommonUIFeatures {
        ...
        public static void drawBook() {
            ...
            render.drawRect(Textures.UIs.book, -200, hh - 110, wh + 200, hh + 110, 0f, 0f, 1f, 1f);
        }
