...
import cn.charlotte.biliforge.util.ui.elements.UIEButton;
import cn.charlotte.biliforge.util.ui.elements.UIEClickZone;
...
public class OverlayPositionsUI extends UI {
    ...
    public UIEButton cancelButton = new UIEButton("取消", Textures.UIs.button_a, 0.5f, 0.5f, 13, 0, -10, true, (ui, mouseButton) -> {
    ...
    public UIEButton applyButton = new UIEButton("应用", Textures.UIs.button_a, 0.5f, 0.5f, -48, 0, -10, true, (ui, mouseButton) -> {
        for (OverlayButton settingsContainer : registeredOverlaySettings) {
    ...
    public UIEButton resetButton = new UIEButton("默认", Textures.UIs.button_a, 0.5f, 0.5f, -22, 15, -10, true, (ui, mouseButton) -> {
        for (OverlayButton settingsContainer : registeredOverlaySettings) {
            try {
